...
var drag_event_args_interface_1 = require("./drag-event-args.interface");
...
var SortableComponent = /** @class */ (function () {
    ...
    SortableComponent.prototype.removeActiveItem = function () {
        if (this.dragIndex >= 0) {
            var dataRemoveArgs = new drag_event_args_interface_1.DataEvent(this.dragIndex, this.data[this.dragIndex]);
    ...
    SortableComponent.prototype.addDataItem = function (dataItem, index) {
        var dataAddArgs = new drag_event_args_interface_1.DataEvent(index, dataItem);
