...
var ListButton = (function () {
    ...
    ListButton.prototype.subscribeComponentBlurredEvent = function () {
        ...
        this._zone.runOutsideAngular(function () {
            _this.documentClick = fromEvent_1.fromEvent(document, 'click').pipe(filter_1.filter(function (event) {
                return !_this.wrapperContains(event.target);
            }));
            _this.componentBlurredSubscription = _this.wrapperBlurred.pipe(merge_1.merge(_this.navigationService.tab, _this.documentClick), filter_1.filter(function () { return _this._isFocused; }))
    ...
    ListButton.prototype.subscribeNavigationEvents = function () {
        ...
        this.closeSubscription = this.navigationService.close
            .pipe(merge_1.merge(this.navigationService.esc))
            .subscribe(function () {
            _this.focusWrapper();
        });
    };
    ...
    ListButton.prototype.focusWrapper = function () {
        if (this._open) {
            ...
            if (this.button && util_1.isDocumentAvailable()) {
