...
/// @group buttons
$button-text: contrast-wcag( $button-bg ) !default;
...
/// @group buttons
$button-hovered-text: contrast-wcag( $button-hovered-bg ) !default;
...
/// @group buttons
$button-pressed-text: contrast-wcag( $button-pressed-bg ) !default;
