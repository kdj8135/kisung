...
var NavigationService = /** @class */ (function () {
    function NavigationService() {
        ...
        this.navigable = true;
        this.actions = (_a = {},
            _a[Keys.up] = function () { return _this.activate(sibling(_this.focusableItem, 'prev')); },
            _a[Keys.down] = function () { return _this.activate(sibling(_this.focusableItem, 'next')); },
            _a[Keys.left] = function () { return (_this.expand({ expand: false, intercept: _this.moveToParent.bind(_this) })); },
            _a[Keys.right] = function () { return (_this.expand({ expand: true, intercept: _this.moveToChild.bind(_this) })); },
