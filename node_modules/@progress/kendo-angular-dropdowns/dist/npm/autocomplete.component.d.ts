import { Renderer2, ElementRef, EventEmitter, ViewContainerRef, TemplateRef, OnDestroy, SimpleChange, OnChanges, ChangeDetectorRef } from '@angular/core';
...
export declare class AutoCompleteComponent implements ControlValueAccessor, OnDestroy, OnChanges {
    ...
    private valueChangeSubscribtion;
    ...
    private findIndexPredicate(text);
}
