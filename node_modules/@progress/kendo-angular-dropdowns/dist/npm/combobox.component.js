...
var ComboBoxComponent = /** @class */ (function () {
    function ComboBoxComponent(rtl, popupService, selectionService, navigationService, cdr, renderer, wrapper) {
    ...
    ComboBoxComponent.prototype.createSelectionStream = function () {
        ...
        this.selectionSubscription =
            this.selectionSubject.pipe(map_1.map(function (index) {
                return {
    ...
    ComboBoxComponent.prototype.createValueStream = function () {
        ...
        var merged = merge_1.merge(valueStream, allowCustomValueStream, disableCustomValueStream);
        this.valueSubscription = merged.pipe(catchError_1.catchError(function () {
            ...
            _this.loading = false;
            _this.disabled = false;
            if (_this.filterable && !util_1.isPresent(state.value) && !util_1.isPresent(state.text) && !util_1.isPresent(_this._previousValue)) {
    ...
    ComboBoxComponent.prototype.subscribeEvents = function () {
        ...
        [
            this.selectionService.onChange.pipe(filter_1.filter(function (event) { return util_1.isPresent(event.indices[0]); }), map_1.map(function (event) { return event.indices[0]; }))
                .subscribe(this.handleItemChange.bind(this)),
            this.selectionService.onSelect.pipe(filter_1.filter(function (event) { return util_1.isPresent(event.indices[0]); }), map_1.map(function (event) { return event.indices[0]; }))
                .subscribe(this.handleItemSelect.bind(this)),
            merge_1.merge(this.navigationService.up, this.navigationService.down, this.navigationService.home, this.navigationService.end).subscribe(function (event) { return _this.navigate(event.index); }),
    ...
    ComboBoxComponent.prototype.resolveState = function () {
        ...
        if (state === InternalState.UseExisting) {
            existing = util_1.resolveValue({ data: this.data, value: primitiveValue, valueField: this.valueField });
    ...
    ComboBoxComponent.prototype.setState = function () {
        ...
        if (this._state & InternalState.UseFilter) {
            ...
            newState.value = util_1.isPresent(this._modelValue) ? this._modelValue : resolved.dataItem;
    ...
    ComboBoxComponent.prototype.confirmSelection = function () {
        ...
        this._filtering = false;
        if (this.allowCustom) {
            isCustom = this.text !== util_1.getter(this.data[focused], this.textField);
        }
        else {
