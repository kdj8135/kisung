...
var remove_tag_event_1 = require("./common/remove-tag-event");
...
var MultiSelectComponent = /** @class */ (function () {
    function MultiSelectComponent(rtl, popupService, selectionService, navigationService, cdr, differs, renderer, hostElement, _zone) {
        var _this = this;
         ...
         * ```
         */
        this.valueNormalizer = function (text) { return text.pipe(map_1.map(function (userInput) {
    ...
    MultiSelectComponent.prototype.subscribeEvents = function () {
        ...
        [
            ...
            this.navigationService.enter.pipe(filter_1.filter(isOpen)).subscribe(this.handleEnter.bind(this)),
            ...
            this.navigationService.up.pipe(filter_1.filter(isOpen)).subscribe(function (event) { return _this.handleUp(event.index); }),
            this.navigationService.home.pipe(filter_1.filter(function () { return isClosed; })).subscribe(this.handleHome.bind(this)),
            this.navigationService.end.pipe(filter_1.filter(function () { return isClosed; })).subscribe(this.handleEnd.bind(this)),
            this.navigationService.backspace.pipe(filter_1.filter(isTagFocused)).subscribe(this.handleBackspace.bind(this)),
            this.navigationService.delete.pipe(filter_1.filter(isTagFocused)).subscribe(this.handleDelete.bind(this)),
    ...
    MultiSelectComponent.prototype.removeGroupTag = function (dataItems) {
        var _this = this;
        var indices = dataItems.map(function (dataItem) { return util_1.selectedIndices([dataItem], _this.data, _this.valueField)[0]; });
        var valuesToRemove = [];
        indices.forEach(function (currentValue, index) {
            if (util_1.isNumber(currentValue)) {
                _this.selectionService.unselect(currentValue);
            }
            else {
                var filter_2 = function (item) { return util_1.getter(item, _this.valueField) !== util_1.getter(dataItems[index], _this.valueField); };
                valuesToRemove.push(_this.value.find(filter_2));
            }
        });
        if (valuesToRemove.length) {
            ...
            valuesToRemove.forEach(function (value) {
                var filter = function (item) { return util_1.getter(item, _this.valueField) !== value; };
    ...
    MultiSelectComponent.prototype.removeSingleTag = function (dataItem) {
        ...
        if (util_1.isNumber(index)) {
            ...
            var filter_3 = function (item) { return util_1.getter(item, _this.valueField) !== util_1.getter(dataItem, _this.valueField); };
            this.value = this.value.filter(filter_3);
            this.selectedDataItems = this.selectedDataItems.filter(filter_3);
            this.tags = this.tagMapper(this.selectedDataItems.slice(0));
            this.cdr.markForCheck();
            this.emitValueChange();
        }
    ...
    MultiSelectComponent.prototype.createCustomValueStream = function () {
        ...
        this.customValueSubscription = this.customValueSubject.pipe(tap_1.tap(function () {
            _this.loading = true;
            _this.disabled = true;
        }), this.valueNormalizer, catchError_1.catchError(function () {
            _this.loading = false;
            ...
            _this.text = "";
            _this.filterChange.emit("");
            if (util_1.isPresent(normalizedValue)) {
                var newValue_2 = _this.valuePrimitive ? util_1.getter(normalizedValue, _this.valueField) : normalizedValue;
                if (_this.value.indexOf(newValue_2) === -1) {
                    ...
                    _this.selectedDataItems = _this.selectedDataItems.filter(function (item) { return util_1.getter(item, _this.valueField) !== newValue_2; });
                }
    ...
    MultiSelectComponent.prototype.handleItemChange = function (event) {
        if (util_1.isPresent(event.added) && event.added !== -1) {
            this.clearFilter();
        }
        this.change(event);
        if (this.autoClose) {
