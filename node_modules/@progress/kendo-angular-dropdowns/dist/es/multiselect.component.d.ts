...
import { Renderer2, ViewContainerRef, ElementRef, TemplateRef, OnDestroy, OnChanges, DoCheck, EventEmitter, AfterContentChecked, AfterViewInit, ChangeDetectorRef, KeyValueDiffers, NgZone } from '@angular/core';
...
export declare class MultiSelectComponent implements OnDestroy, OnChanges, DoCheck, AfterContentChecked, AfterViewInit {
     ...
     * [`valuePrimitive`]({% slug valuebinding_multiselect %}#toc-primitive-values-from-object-fields) property.
     */
    ...
    constructor(rtl: boolean, popupService: PopupService, selectionService: SelectionService, navigationService: NavigationService, cdr: ChangeDetectorRef, differs: KeyValueDiffers, renderer: Renderer2, hostElement: ElementRef, _zone: NgZone);
    ...
    private removeGroupTag(dataItems);
    private removeSingleTag(dataItem);
    ...
    private findIndex(text);
    private searchTextAndFocus(text);
    private closePopup();
    private openPopup();
