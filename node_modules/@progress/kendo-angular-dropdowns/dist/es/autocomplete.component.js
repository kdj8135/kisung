...
var AutoCompleteComponent = /** @class */ (function () {
    ...
    AutoCompleteComponent.prototype.ngOnChanges = function (changes) {
        var isInitial = Boolean(changes.value && changes.value.firstChange || (isChanged("value", changes) && (this._state & InternalState.SetInitial)));
        if (isInitial) {
    ...
    AutoCompleteComponent.prototype.subscribeEvents = function () {
        ...
        this.valueChangeSubscribtion = this.valueChangeSubject.pipe(filter(function (candidate) {
        ...
        this.navigationSubscribtion = merge(this.navigationService.up, this.navigationService.down).subscribe(function (event) { return _this.navigate(event.index); });
