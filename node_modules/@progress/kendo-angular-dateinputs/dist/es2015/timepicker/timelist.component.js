...
export class TimeListComponent {
    ...
    itemOffset(top) {
        const diff = top - this.virtualization.itemOffset(this.virtualization.activeIndex());
        const itemHeight = this.itemHeight;
        const topThreshold = itemHeight * SNAP_THRESHOLD;
        const bottomThreshold = itemHeight * (1 - SNAP_THRESHOLD);
        const scrolledDown = diff < (itemHeight / 2);
        const shouldSwitch = diff > topThreshold && diff < bottomThreshold;
