import { ChangeDetectorRef, ElementRef, EventEmitter, NgZone, TemplateRef, ViewContainerRef, OnInit, OnChanges, OnDestroy, Renderer2 } from '@angular/core';
 ...
 */
export declare class TimePickerComponent implements ControlValueAccessor, OnInit, OnChanges, OnDestroy {
    zone: NgZone;
    ...
    constructor(zone: NgZone, localization: LocalizationService, cdr: ChangeDetectorRef, popupService: PopupService, element: ElementRef, renderer: Renderer2, touchEnabled: boolean, rtl: boolean);
    /**
     * @hidden
