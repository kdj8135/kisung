...
export class CenturyViewService {
    ...
    data(options) {
        const { cellUID, focusedDate, isActiveView, max, min, selectedDate, viewDate } = options;
        if (!viewDate) {
            return EMPTY_DATA;
        }
    ...
    viewDate(date, max, border = 1) {
        const renderTwoViews = durationInCenturies(date, max) < border;
...
/** @nocollapse */
CenturyViewService.ctorParameters = () => [];
