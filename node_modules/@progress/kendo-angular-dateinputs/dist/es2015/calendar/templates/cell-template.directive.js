 ...
 *
 * To define the cell template, nest an `<ng-template>` tag with the `kendoCalendarCellTemplate` directive
 ...
 * To provide more details about the current cell, get a reference to the current `cellContext`
