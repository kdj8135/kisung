    ...
    parsePart(symbol, currentChar, resetSegmentValue) {
        ...
        for (let i = Math.max(0, currentMaxLength); i <= current.length; i++) {
            ...
            if (parsedDate) {
                ...
                this.setExisting(symbol, true);
                const switchToNext = peekDate === null || (leadingZero[symbol] && patternValue.length <= middle.length);
...
export class DateInputComponent {
    constructor(cdr, intl, renderer, element, localization) {
        this.cdr = cdr;
        this.intl = intl;
    ...
    handleInput() {
        ...
        const diff = approximateStringMatching(this.currentValue, this.currentFormat, this.dateInput.nativeElement.value, this.caret()[0]);
     ...
     */
    triggerChange() {
        const dateObject = this.kendoDate.getDateObject();
    ...
    updateElementValue(isActive) {
        ...
        const showPlaceholder = !this.isActive && this.placeholder && !this.kendoDate.hasValue();
    ...
    caret(start, end = start) {
        ...
        const element = this.dateInput.nativeElement;
