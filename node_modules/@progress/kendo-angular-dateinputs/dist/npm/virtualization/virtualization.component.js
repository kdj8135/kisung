...
var VirtualizationComponent = /** @class */ (function () {
    ...
    VirtualizationComponent.prototype.ngAfterViewInit = function () {
        ...
        this.zone.runOutsideAngular(function () {
            _this.containerScrollSubscription = _this.scroll$()
                .pipe(map_1.map(function (event) { return event.target; }))
    ...
    VirtualizationComponent.prototype.animateToIndex = function (index) {
        ...
        this.zone.runOutsideAngular(function () {
            _this.animationSubscription = of_1.of(start)
                .pipe(combineLatest_1.combineLatest(interval_1.interval(0, animationFrame_1.animationFrame)), map_1.map(function (stream) { return stream[0]; }), scan_1.scan(modifyScroll), takeWhile_1.takeWhile(isScrollValid), map_1.map(normalizeScroll))
    ...
    VirtualizationComponent.prototype.scroll$ = function () {
        return util_1.isDocumentAvailable() ? fromEvent_1.fromEvent(this.container.nativeElement, 'scroll') : empty_1.empty();
    };
