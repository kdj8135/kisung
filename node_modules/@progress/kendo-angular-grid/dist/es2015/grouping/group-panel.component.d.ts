...
export declare class GroupPanelComponent implements OnDestroy {
    ...
    constructor(hint: DragHintService, cue: DropCueService, groupInfoService: GroupInfoService, localization: LocalizationService);
    ...
    private enter({draggable, target});
    private leave();
    private drop({target, draggable});
}
