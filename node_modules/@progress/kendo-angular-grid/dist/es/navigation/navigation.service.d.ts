import { EventEmitter, NgZone, OnDestroy, ChangeDetectorRef } from '@angular/core';
...
export declare class NavigationService implements OnDestroy {
    ...
    constructor(zone: NgZone, domEvents: DomEventsService, pagerContextService: PagerContextService, scrollRequestService: ScrollRequestService, groupsService: GroupsService, focusRoot: FocusRoot, editService: EditService, cd: ChangeDetectorRef, rtl: boolean);
    init(meta: NavigationMetadata): void;
    ngOnDestroy(): void;
    registerCell(cell: LogicalCell): void;
    registerRow(row: LogicalRow): void;
    unregisterRow(row: LogicalRow): void;
