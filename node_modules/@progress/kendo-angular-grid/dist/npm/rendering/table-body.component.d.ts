...
export declare class TableBodyComponent implements OnInit, OnDestroy {
    ...
    isSpanColumn(column: any): boolean;
    isCheckboxColumn(column: any): boolean;
    childColumns(column: ColumnBase): ColumnBase[];
    isBoundColumn(column: any): boolean;
    private clickHandler(eventArg);
    private cellKeydownHandler(args);
