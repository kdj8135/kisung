...
@Component({
  selector: 'app-productworklist',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './product_work_list.component.html',
  styleUrls: ['./product_work_list.component.css']
})
export class product_work_listComponent implements OnInit {
  ...
  public change_outsourcing_cd: string;
  public change_outsourcing_list: Array<any>;
  public change_worker_id: string;
  public change_worker_list: Array<any>;
  ...
  @Input() PRODUCT_WORK_TYPE: string = "WORK";
  @Input() PRODUCT_WORK_MENU_ID: string = "42";
  ...
  ngOnInit() {
    ...
    this.change_outsourcing_cd = "all";
    this.change_worker_id = "all";
    ...
    this.pmsApiService.fetch('WPCommon/commoncode_2lvl', param).subscribe(result => {
      this.change_outsourcing_list = result.data;
    });
    this.change_outsourcing_cd="all";
  ...
  change_update() {
    ...
    let param = [{
      ...
      , change_outsourcing_cd: this.change_outsourcing_cd
      , change_worker_id: this.change_worker_id
    ...
    this.notificationService.smartMessageBox({
      ...
      if (ButtonPressed === "변경") {
        this.pmsApiService.fetch('productwork/product_work_change_update', param, "patch").subscribe(result => {
          if (result.code == "00") {
            //this.mySelection = [];
            this.selectAllState = 'unchecked';
            this.searchGrid();
