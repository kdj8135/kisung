...
export const userRoutes: Routes = [
  ...
  {path: 'roleassignuser', component: RoleassignuserComponent, data: {pageTitle: '역할별 사용자 설정'}},
  {path: 'roleassign', component: RoleassignComponent, data: {pageTitle: '사용자별 역할 설정'}},
